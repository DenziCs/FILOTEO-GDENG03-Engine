...
void ACube::update(float delta_time) {
	...
	float lerpFactor = 0.5f * (sin(mElapsedTime) + 1.f);
	this->setPosition(Vector3::lerp(Vector3(-0.5f, -0.5f, 1.3f), Vector3(0.5f, 0.5f, 1.3f), lerpFactor));
	this->setScale(Vector3::lerp(Vector3(1.f, 1.f, 1.f), Vector3(0.25f, 0.25f, 0.25f), lerpFactor));
}
